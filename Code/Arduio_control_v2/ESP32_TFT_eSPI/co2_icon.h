...
#ifndef LV_ATTRIBUTE_IMG_CO2_ICON
#define LV_ATTRIBUTE_IMG_CO2_ICON
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CO2_ICON uint8_t co2_icon_map[] = {
